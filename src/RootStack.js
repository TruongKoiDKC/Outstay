...
const TabsNav = createBottomTabNavigator({
  ManHinhPhongTro: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: ({tintColor, focused}) => {
        if (focused) {
          return <FontAwesome5 name="door-open" size={22} color={'#5aaf76'} />;
        } else {
          return <FontAwesome5 name="door-open" size={22} color={'gray'} />;
        }
      },
    },
  },
  ...
  ManHinhDichVu: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: ({tintColor, focused}) => {
        if (focused) {
          return (
            <Foundation name="clipboard-notes" size={25} color={'#5aaf76'} />
          );
        } else {
          return <Foundation name="clipboard-notes" size={25} color={'gray'} />;
        }
      },
    },
  },
  ...
  ManHinhKhachHang: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: ({tintColor, focused}) => {
        if (focused) {
          return <Feather name="user" size={26} color={'#5aaf76'} />;
        } else {
          return <Feather name="user" size={26} color={'gray'} />;
        }
      },
    },
  },
  ...
  ManHinhHoaDon: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: ({tintColor, focused}) => {
        if (focused) {
          return <FontAwesome5 name="receipt" size={23} color={'#5aaf76'} />;
        } else {
          return <FontAwesome5 name="receipt" size={23} color={'gray'} />;
        }
      },
    },
  },
  ...
  ManHinhThongKe: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: ({tintColor, focused}) => {
        if (focused) {
          return <Foundation name="graph-trend" size={30} color={'#5aaf76'} />;
        } else {
          return <Foundation name="graph-trend" size={30} color={'gray'} />;
        }
      },
    },
  },
  ...
  ManHinhCaiDat: {
    ...
    navigationOptions: {
      ...
      tabBarIcon: ({tintColor, focused}) => {
        if (focused) {
          return <MaterialIcons name="settings" size={25} color={'#5aaf76'} />;
        } else {
          return <MaterialIcons name="settings" size={25} color={'gray'} />;
        }
      },
    },
  },

...
export default class PDFExample extends React.Component {
    ...
    actualDownload = () => {
     ...
     RNFetchBlob.config({
       ...
       notification: true,
       mediaScannable: true,
       title: `BanKhaiThayDoiNhanKhau.pdf`,
       path: `${dirs.DownloadDir}/BanKhaiThayDoiNhanKhau.pdf`,
       },
     })
       .fetch('GET', 'https://congan.quangninh.gov.vn/thutuchanhchinh/detail/DANG-KY-THUONG-TRU-253/?download=1&id=1', {})
       .then((res) => {
   ...
   downloadFile = async () => {
    ...
    render() {
        let source = {uri:'https://visana.vn/wp-content/uploads/2019/04/M%E1%BA%ABu-Phi%E1%BA%BFu-b%C3%A1o-thay-%C4%91%E1%BB%95i-h%E1%BB%99-kh%E1%BA%A9u-nh%C3%A2n-kh%E1%BA%A9u-HK02-1.pdf',cache:true};

...
export default class PDFExample extends React.Component {
    ...
    actualDownload = () => {
     ...
     RNFetchBlob.config({
       ...
       notification: true,
       mediaScannable: true,
       title: `BanKhaiNhanKhau.pdf`,
       path: `${dirs.DownloadDir}/BanKhaiNhanKhau.pdf`,
       },
     })
       .fetch('GET', 'https://congan.quangninh.gov.vn/thutuchanhchinh/detail/DANG-KY-THUONG-TRU-253/?download=1&id=0', {})
       .then((res) => {
   ...
   downloadFile = async () => {
    ...
    render() {
        let source = {uri:'http://s1.vndoc.com/data/file/2015/Thang12/14/Ban_Khai_Nhan_Khau-Mau-HK01.pdf',cache:true};

                ...
                <View>
                  <Animated.View style={styles.vienkhung}>
                    <View style={{padding: 8}}>
                      ...
                      />
                      <TextInput
                        placeholder="Loại dịch vụ / Loại phòng"
                        underlineColorAndroid="#5aaf76"
                        style={{fontSize: 15}}
                        onChangeText={text =>
                          this.setState({itemLoaiDichVu: text})
                        }
                      ...
                      <TextInput
                        ...
                        style={{fontSize: 15}}
                        onChangeText={text =>
                          this.setState({itemDienTich: text})
                        }
                      ...
                      <View style={{flexDirection: 'row'}}>
                        ...
                        <View style={{flex: 1}}>
                          <TextInput
                            ...
                            style={{fontSize: 15}}
                            onChangeText={text =>
                              this.setState({itemDonViTinh: text})
                            }

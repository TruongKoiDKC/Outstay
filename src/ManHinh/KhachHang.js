                ...
                renderItem={({ item }) => (
                  <View>
                    <ScrollView horizontal={true}>
                      ...
                      >
                        <View>
                          <Text style={styles.item}>- Họ và tên : {item.HovaTen} </Text>
                          <Text style={styles.item}>- Ngày sinh : {item.NgaySinh} </Text>
                          <Text style={styles.item}>- Địa chỉ : {item.DiaChi} </Text>
                          <Text style={styles.item}>- CMND/CMT/CCCD : {item.CMNhanDan} </Text>
                          <Text style={styles.item}>- Số điện thoại : {item.SoDT} </Text>
